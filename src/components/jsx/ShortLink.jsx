      ...
      <div className="flex flex-col mx-auto bg-[#3b3054] border-2 w-[340px] px-5 py-5 mt-10 rounded-xl relative overflow-hidden">
        ...
        <form onSubmit={handleSubmit}>
          <input
            ...
            className="py-4 rounded-lg px-6 placeholder:font-bold placeholder:text-xl"
            type="text"
            id="originalUrl"
            value={IsoriginalUrl}
          ...
          <button
            type="submit"
            className="text-white bg-[#2BD0D0] py-4 mt-5 rounded-lg z-50 font-bold text-xl tracking-wide"
          >
            Shorten it!
          </button>
        </form>
