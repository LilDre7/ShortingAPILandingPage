...
const ButtonGetStarted = () => {
  return (
    <>
      <button className="border text-gray-50  duration-300 relative group cursor-pointer overflow-hidden h-14 w-56 rounded-2xl bg-neutral-800 p-2  font-extrabold hover:bg-sky-700">
